...
@section('content')
    <x-pageTitle title="Recipes">
        <a class="kt-btn kt-btn-primary" href="{{ route('recipe.create') }}"><i class="fa-solid fa-plus"></i> Add New</a>
    </x-pageTitle>
            ...
            <table id="myTable" class="display" style="width:100%">
                ...
                <tbody>
                    <tr>
                        ...
                        <td><span class="size-6 inline-flex items-center text-sm rounded-xs bg-gray-100 border border-gray-200 justify-center">5</span></td>
                        <td><span class="kt-badge border border-[#B7EB8F] bg-[#F6FFED] text-[#52C41A] rounded-xs">Ovulation</span></td>
                        <td>
